                            ...
                            <div className="col-md-12">
                                <div className="bottom">
                                    <div className="position-relative w-100">
                                        ...
                                        <button onClick={chatFunc} className="btn send"><i className="material-icons">send</i></button>
                            ...
                            <div className="container">
                                <div className="col-md-12">
                                    <div className="inside">
                                        <div className="panel">
                                            <div className="participant">
                                                <img className="avatar-xxl" src="dist/img/avatars/avatar-female-2.jpg" alt="avatar"></img>
                                                <span>Connecting</span>
                                            </div>							
                                            <div className="options">
                                                <button className="btn option"><i className="material-icons md-30">mic</i></button>
